...
testconformance: ## Run all conformance tests
	...
	PATH="$(abspath $(BIN)):$(PATH)" connectconformance --trace --conf -v ./Tests/ConformanceClient/InvocationConfigs/urlsession.yaml --mode client $(BIN)/ConnectConformanceClient httpclient=urlsession
	PATH="$(abspath $(BIN)):$(PATH)" connectconformance --trace --conf -v ./Tests/ConformanceClient/InvocationConfigs/nio.yaml --mode client $(BIN)/ConnectConformanceClient httpclient=nio
